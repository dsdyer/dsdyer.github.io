...
{
var target = getEventTarget(evt);keys[evt.keyCode] = false;var key = getKeyCode(evt);var keyChar = String.fromCharCode(key);if (isFModeLayout() && target && (target.getAttribute('onkeyup') != null
 ...
 return false; if (target && target.form && target.form.name != "win0")
 return findHandler("doKeyUp_" + target.form.name, evt); if (isCtrlKey(evt) && isAltKey(evt) && key == 83 && (typeof (bDoModal_win0) == "undefined" || !bDoModal_win0)) { 
...
function doUpdateParent(form, name) {
 ...
 return; if (typeof winParent == 'undefined' || winParent == null ) {
